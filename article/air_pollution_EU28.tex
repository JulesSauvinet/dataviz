...
\keywords{Air pollution, Pollutant, Ammonia, Sulfur oxides, Non-methane volatile organic compounds, Nitrogen oxides, Particle matters, EU28, Ecology, Health.}
...
\paragraph{}
Taking note of this issue, ce created a model which would have as ambition to inform people on the evolution of the population over the last years. Our model will also have to be able to geolocate (by country) pollution according to the pollutants.
...
\begin{figure}[H]
 ...
 \caption{A visualization of a small map. The image is from our visualization.}
...
\paragraph{}
To be more accurate, next to the 12 pollutant small maps, there is a button radio list of 6 pollutants. By default, when the Web Page is loaded, the pollutant on top of the list is selected. When an other button radio of the list is selected, the 12 small maps are updated, as well as the legend and the title. 
\paragraph{}
