...
%% Paper title.
\title{Exploring potential causes, consequences and visualizing evolution of major air pollutants emission over EU28}
...
\item
 Jules Sauvinet is studying at Universite Claude Bernard Lyon I. E-mail: contact@julessauvinet.fr
\item
 Marine Ruiz is studying at Universite Claude Bernard Lyon I. E-mail: marine.ruiz@etu.univ-lyon1.fr
}
...
\teaser{
  ...
  \caption{Main view of the visualization: The smallMaps of pollution on the top (the pollutant chose is Ammoniac) and the smallMaps of the mesure below (the mesure chose is the pesticides)}
	\label{fig:teaser}
}
