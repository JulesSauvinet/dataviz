...
\keywords{Air pollution, Pollutant, Ammoniac, Sulphur oxides, Non-methane volatil organic compounds, Nitrogen oxides, Particles fines, EU28, Ecology, Small multiple, Small multiple maps, Maps, Data visualization, Geographical data visualization,
...
\teaser{
  ...
  \caption{Main view of the visualization: 12 small maps of EU28 colored according to Non-methane volatil oraganic compounds emissions on the top and 12 small multiple maps of EU28 showing primary production of energy from 2003 to 2014.}
	\label{fig:teaser}
}
...
\begin{figure}[H]
 ...
 \caption{A visualization of a small map of ammonia emissions. The image is from our visualisation.}
